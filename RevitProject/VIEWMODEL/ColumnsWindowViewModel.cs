        ...
        public void DoneCommand()
        {
            ...
            foreach (PolyLine pl in plines)
            {
                ...
                if (layer == _selectedlayer)
                {
                    ...
                    if (flag)
                    {
                        FamilySymbol familySymbol = new FilteredElementCollector(Doc).OfCategory(BuiltInCategory.OST_Columns).WhereElementIsElementType().Where(x => x.Name == "475 x 610mm" || x.Name == "610 x 610mm" || x.Name == "457 x 475mm" || x.Name == "18\" x 18\"" || x.Name == "18\" x 24\"" || x.Name == "24\" x 24\"").FirstOrDefault() as FamilySymbol;
